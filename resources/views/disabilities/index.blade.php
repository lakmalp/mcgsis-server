...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="row">
                <div class="col">
                    <a href="{{route('disabilities.create')}}" class="btn btn-light btn-sm float-right my-1" role="button">
                ...
                <div class="col">
                    <div class="card">
                        <div class="card-header">
                            <span class="card-header-custom"><i class="fas fa-blind mr-2"></i> Disabilities</span>
                        </div>
                        <div class="card-text">
                            <table class="table table-hover table-bordered table-sm">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td style="text-align: center" class="text-gray"><a href="{{route('disabilities.edit', [$disability->id])}}"><i class="far fa-edit"></i></a> | <button class="btn btn-light px-1 mx-0" onclick="deleteHouse({{$disability->id}}, '{{$disability->description}}');"><i class="far fa-trash-alt"></i></button></td>
                                        <td>{{ $disability->id }}</td>
...
<div class="modal fade" id="dlgModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <input type="hidden" id="route" value="{{route('disabilities.index')}}">
...
<script type="text/javascript">
    function deleteHouse(id, description) {
        ...
        $('#route').val("{{route('disabilities.index')}}" + "/" + id)
        $('#dlgModal').modal('show');
    }
